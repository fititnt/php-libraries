...
$resultado = $correio->origem( '90650000' )->destino( '86010060' )->json(); //Imprime JSON
//$resultado = $correio->origem( '90650000' )->destino( '86010060' )->json('text/json'); //Imprime JSON, mime-type nao padrao
